/*Recursively print all sentences that can be formed from list of word lists -> Given a list of word lists How to print all sentences possible taking one word from a list at a time via recursion? */
#include <bits/stdc++.h>
using namespace std;
